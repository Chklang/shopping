...
@Component({
  templateUrl: './shopsdetailsmodify.component.html',
  styleUrls: ['./shopsdetailsmodify.component.css']
})
export class ShopsdetailsmodifyComponent extends AbstractItemsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.activatedRoute.params.subscribe((pParams: IParamsOpenView) => {
      this.init(pParams.idShop, 'modify').then(() => {
